...
title PokeTama V10 - Envoi simple vers Test-2
cd /d "%~dp0"

echo PokeTama V10 - envoi vers Moretro3D/Test-2
echo.
where git >nul 2>nul
if errorlevel 1 (
...
echo Preparation des fichiers V10...
...
if errorlevel 1 (
  git -c safe.directory="%CD%" commit -m "PokeTama V10 - presentation du combat"
...
echo Envoi de la V10 sans effacement ni force push...
