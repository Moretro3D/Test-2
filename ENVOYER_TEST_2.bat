...
title PokeTama V9.87 - Envoi vers Test-2 uniquement
cd /d "%~dp0"

set "REPO_URL=https://github.com/Moretro3D/Test-2.git"
echo ============================================================
echo  PokeTama V9.87 - ENVOI SECURISE VERS TEST-2
echo ============================================================
...
if errorlevel 1 git commit -m "PokeTama V9.87 - Boite separee de la navigation"
git branch -M main
