...
title PokeTama V10.33 - Envoi vers Test-2
cd /d "%~dp0"

echo PokeTama V10.33 - envoi vers Moretro3D/Test-2
echo.
where git >nul 2>nul
if errorlevel 1 (
...
echo Preparation des fichiers V10.33...
...
echo Envoi de la V10.33 sans effacement ni force push...
