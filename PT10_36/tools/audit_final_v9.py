...
ok("1.46.115-moretro3d-v10.36-box-pmd-sprites" in ino and
   "1.46.115-moretro3d-v10.36-box-pmd-sprites" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.115-moretro3d-v10.36-box-pmd-sprites" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.115-moretro3d-v10.36-box-pmd-sprites" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.115-moretro3d-v10.36-box-pmd-sprites" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.115 coherente et caches installateur invalides")
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.115-moretro3d-v10.36-box-pmd-sprites" in test2_launcher,
