...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "REINICIAR", "BORRAR TODA LA PARTIDA?", "BORRAR Y REINICIAR",
  },
  // ---------------- EN ----------------
  {
    ...
    "RESET", "ERASE THE WHOLE SAVE?", "ERASE AND RESTART",
  },
  // ---------------- FR ----------------
  {
    ...
    "REINITIALISER", "EFFACER TOUTE LA PARTIE?", "EFFACER ET REDEMARRER",
  },
  // ---------------- DE ----------------
  {
    ...
    "ZURUECKSETZEN", "GANZEN SPIELSTAND LOESCHEN?", "LOESCHEN UND NEUSTART",
  },
  // ---------------- IT ----------------
  {
    ...
    "RIPRISTINA", "CANCELLARE TUTTO IL SALVATAGGIO?", "CANCELLA E RIAVVIA",
  },
  // ---------------- PT ----------------
  {
    ...
    "REINICIAR", "APAGAR TODO O PROGRESSO?", "APAGAR E REINICIAR",
  },
};
