...
ok("1.46.102-moretro3d-v10.23-wide-water-habitat" in ino and
   "1.46.102-moretro3d-v10.23-wide-water-habitat" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.102-moretro3d-v10.23-wide-water-habitat" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.102-moretro3d-v10.23-wide-water-habitat" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.102-moretro3d-v10.23-wide-water-habitat" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.102 coherente et caches installateur invalides")
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.102-moretro3d-v10.23-wide-water-habitat" in test2_launcher,
...
ok('#include "home_habitat_sprites.h"' in ino and
   ...
   "const int16_t x0=23, y0=205" in ino and
