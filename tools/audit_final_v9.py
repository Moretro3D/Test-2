...
ok("1.46.98-moretro3d-v10.19-home-habitats" in ino and
   "1.46.98-moretro3d-v10.19-home-habitats" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.98-moretro3d-v10.19-home-habitats" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.98-moretro3d-v10.19-home-habitats" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.98-moretro3d-v10.19-home-habitats" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.98 coherente et caches installateur invalides")
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.98-moretro3d-v10.19-home-habitats" in test2_launcher,
