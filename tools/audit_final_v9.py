...
ok("1.46.114-moretro3d-v10.35-box-popup-sprites" in ino and
   "1.46.114-moretro3d-v10.35-box-popup-sprites" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.114-moretro3d-v10.35-box-popup-sprites" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.114-moretro3d-v10.35-box-popup-sprites" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.114-moretro3d-v10.35-box-popup-sprites" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.114 coherente et caches installateur invalides")
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.114-moretro3d-v10.35-box-popup-sprites" in test2_launcher,
...
ok("void drawBoxSelectionThumbCentered(const uint8_t *b, int cx, int cy)" in ino and
   "int scale=min(144/visibleW,108/visibleH);" in ino and
   ...
   "grand sprite du popup ajuste sans toucher aux huit vignettes")
