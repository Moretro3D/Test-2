...
ok("1.46.93-moretro3d-v10.14-box-favorites" in ino and
   "1.46.93-moretro3d-v10.14-box-favorites" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.93-moretro3d-v10.14-box-favorites" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.93-moretro3d-v10.14-box-favorites" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.93-moretro3d-v10.14-box-favorites" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.93 coherente et caches installateur invalides")
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.93-moretro3d-v10.14-box-favorites" in test2_launcher,
