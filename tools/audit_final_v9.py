...
ok("1.46.78-moretro3d-v9.99-battle-touch" in ino and
   "1.46.78-moretro3d-v9.99-battle-touch" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.78-moretro3d-v9.99-battle-touch" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.78-moretro3d-v9.99-battle-touch" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.78 coherente et cache installateur invalide")
...
ok("gfx->setCursor(msgX,306); gfx->print(battleMsg);" in ino and
   ...
   "effets de combat remontes et quatre grandes zones tactiles")
