...
ok("1.46.100-moretro3d-v10.21-home-habitats-raised" in ino and
   "1.46.100-moretro3d-v10.21-home-habitats-raised" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.100-moretro3d-v10.21-home-habitats-raised" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.100-moretro3d-v10.21-home-habitats-raised" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.100-moretro3d-v10.21-home-habitats-raised" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.100 coherente et caches installateur invalides")
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.100-moretro3d-v10.21-home-habitats-raised" in test2_launcher,
...
ok('#include "home_habitat_sprites.h"' in ino and
   ...
   "const int16_t x0=73, y0=210" in ino and
   "if (color)" in ino and
