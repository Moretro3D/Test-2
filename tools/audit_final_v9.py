...
ok("1.46.94-moretro3d-v10.15-home-gym-cabin" in ino and
   "1.46.94-moretro3d-v10.15-home-gym-cabin" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.94-moretro3d-v10.15-home-gym-cabin" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.94-moretro3d-v10.15-home-gym-cabin" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.94-moretro3d-v10.15-home-gym-cabin" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.94 coherente et caches installateur invalides")
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.94-moretro3d-v10.15-home-gym-cabin" in test2_launcher,
...
ok("void drawHomeGymCabin(uint8_t phase, uint8_t biome)" in ino and
   ...
   "x >= 326 && x <= 438 && y >= 132 && y <= 246" in ino and
   "cardPage = 9" in ino and "kantoArenaDetail = -1" in ino,
   "cabane pixel art accueil tactile ouvrant directement les arenes Kanto")
