...
ok("1.46.110-moretro3d-v10.31-rock-platform-art" in ino and
   "1.46.110-moretro3d-v10.31-rock-platform-art" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.110-moretro3d-v10.31-rock-platform-art" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.110-moretro3d-v10.31-rock-platform-art" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.110-moretro3d-v10.31-rock-platform-art" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
   "version 1.46.110 coherente et caches installateur invalides")
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.110-moretro3d-v10.31-rock-platform-art" in test2_launcher,
...
ok("paste_on_fixed_baseline(scene, enemy, 128, 48)" in (ROOT/"tools/make_battle_bases.py").read_text(encoding="utf-8") and
   ...
   "cinq sols joueur a Y108, roche a Y112 et adversaires a Y48")
