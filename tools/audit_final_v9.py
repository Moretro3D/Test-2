...
ok("1.46.104-moretro3d-v10.25-full-bleed-habitats" in ino and
   "1.46.104-moretro3d-v10.25-full-bleed-habitats" in (ROOT/"web/manifest.json").read_text(encoding="utf-8") and
   "1.46.104-moretro3d-v10.25-full-bleed-habitats" in (ROOT/"web/index.html").read_text(encoding="utf-8") and
   "1.46.104-moretro3d-v10.25-full-bleed-habitats" in (ROOT/"web/shopify.html").read_text(encoding="utf-8") and
   "1.46.104-moretro3d-v10.25-full-bleed-habitats" in (ROOT/"tools/build_web.sh").read_text(encoding="utf-8"),
...
ok("https://moretro3d.github.io/Test-2/?v=1.46.104-moretro3d-v10.25-full-bleed-habitats" in test2_launcher,
...
ok("void drawHomeGymCabin(uint8_t phase, uint8_t biome)" in ino and
   ...
   "x >= 169 && x <= 297 && y >= 89 && y <= 205" in ino and
   "const int16_t x0=169, y0=93" in ino and
