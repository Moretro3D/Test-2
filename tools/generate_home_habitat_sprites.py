...
# Smaller safe inset, raised above the old horizon. Drawn at x2, every habitat
# is 320x180 and remains fully readable inside the round display.
W, H = 160, 90
DISPLAY_X, DISPLAY_Y = 73, 210
