...
# Safe inset inside the 466 px round display. Drawn at x2, the artwork is
# 368x200 and no longer loses its important side details against the bezel.
W, H = 184, 100
DISPLAY_X, DISPLAY_Y = 49, 236
