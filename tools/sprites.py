...
def heart():
    # Coeur d'affection Pokemon, construit sur une grille logique 16x16 puis
    # agrandi en pixels 2x : silhouette reguliere et details toujours nets.
    g = G()
    logical = [
        "................", "................", "...kkk...kkk....",
        "..krrrk.kRRRk...", ".krrrrrkrRRRRk..", ".krrrrrrrrRRRk..",
        ".krrwwrrrrRRRk..", ".krrwrrrrrRRRk..", "..krrrrrrRRRk...",
        "...krrrrRRRk....", "....krrrRRk.....", ".....krrRk......",
        "......kRk.......", ".......k........", "................",
        "................",
    ]
    for ly, row in enumerate(logical):
        for lx, colour in enumerate(row):
            if colour != '.':
                g.rect(lx * 2, ly * 2, lx * 2 + 1, ly * 2 + 1, colour)
    return g.rows()
